...
if (isset($_POST['firstName']) && isset($_POST['lastName']) && isset($_POST['email']) && isset($_POST['cpf']) && isset($_POST['password'])) {
    ...
    $sql_code = "CALL spIncluiCliente(?, ?, ?, ?, md5(?))";
    $stmt = $con->prepare($sql_code);

    // Vincule os parâmetros
    $stmt->bind_param("sssss", $firstName, $lastName, $email, $cpf, $password);
                ...
                <div class="col-md-7 col-lg-8">
                    ...
                    <form class="needs-validation" method="post" novalidate>
                        <div class="row g-3">
                            ...
                            <div class="col-12">
                                <label for="email" class="form-label">Email <span class="text-body-secondary">(Será usado como
                                        login)</span></label>
