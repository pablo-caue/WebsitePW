          ...
          <form class="needs-validation" method="post" novalidate>
            <div class="row g-3">
              ...
              <div class="col-12">
                ...
                <input type="email" class="form-control" id="email" name="email" placeholder="joao@exemplo.com" required
                  maxlength="32">
                <div class="invalid-feedback">
              ...
              <div class="col-12">
                <label for="address" class="form-label">CPF <span class="text-body-secondary">(Será usado como
                    login)</span></label>
...
if (isset($_POST['firstName']) || isset($_POST['lastName']) || isset($_POST['email']) || isset($_POST['cpf']) || isset($_POST['password'])) {
    ...
    $sql_code = "CALL spIncluiCliente('$firstName', '$lastName', '$email', '$cpf', '$password')";
